...
import gambarbromeliad from '../images/gambarbromeliad.png';
            ...
            <Container className='pt-5 pb-5'>
                <Row>
                    <Col className='bahan pt-5'>
                        ...
                        <ul>
                            <li>Siapkan pot untuk tanaman Bromeilad</li>
                            <li>Siapkan tanah sebagai media tanam</li>
                            <li>Siapkan tanaman Bromeilad</li>
                        </ul>
