    ...
    <div class="col-md-12">
      ...
      <div className='artikel'>
        ...
        <div  className='col-md-3'>
          <div><Card style={{ width: '270px', height: '530px', marginLeft: '22%', marginTop: '10px' }}>
            <img src={janda} />
            <Card.Body>
          ...
          <div  className='col-md-3'>
          <div><Card style={{ width: '270px', height: '530px', margin: '10px', marginLeft: '15%' }}>
            <img src={buttonwood} />
            <Card.Body>
          ...
          <div  className='col-md-3'>
          <div><Card style={{ width: '270px', height: '530px', margin: '10px', marginLeft: '8%' }}>
            <img src={peony} />
            <Card.Body>
          ...
          <div  className='col-md-3'>
          <div><Card style={{ width: '270px', height: '530px', margin: '10px', marginLeft: '0%' }}>
            <img src={sepatu} />
            <Card.Body>
      ...
      <div className='bawah'>
          ...
          <div className='logososialmedia'>
            <div className='fb'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
            ...
            <div className='ig'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16" >
