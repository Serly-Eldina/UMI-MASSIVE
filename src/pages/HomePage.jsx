    ...
    <div class="col-md-12">
      ...
      <div className='artikel'>
        ...
        <div  className='col-md-3'>
          <a class="fb" href="#"><Card style={{ width: '270px', height: '530px', marginLeft: '22%', marginTop: '10px' }}>
            <img src={janda} />
            <Card.Body>
          ...
          <div  className='col-md-3'>
          <a class="fb" href="#"><Card style={{ width: '270px', height: '530px', margin: '10px', marginLeft: '15%' }}>
            <img src={buttonwood} />
            <Card.Body>
          ...
          <div  className='col-md-3'>
          <a class="fb" href="#"><Card style={{ width: '270px', height: '530px', margin: '10px', marginLeft: '8%' }}>
            <img src={peony} />
            <Card.Body>
          ...
          <div  className='col-md-3'>
          <a class="fb" href="#"><Card style={{ width: '270px', height: '530px', margin: '10px', marginLeft: '0%' }}>
            <img src={sepatu} />
            <Card.Body>
      ...
      <div className='bawah'>
          ...
          <div className='logososialmedia'>
            ...
            <a class="fb" href="https://youtube.com">
